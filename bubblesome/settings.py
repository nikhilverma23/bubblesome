...
# Django settings for bubblesome project.
...
MEDIA_URL = 'https://www.bubblesome.com/media/'
...
STATIC_URL = 'http://www.bubblesome.com/static/'
...
SECRET_KEY = '(txbk)bd#5jxn8t#n4tz%huw(0i@bn^m@w66e5^1okb8xy2i-n'
...
ROOT_URLCONF = 'bubblesome.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bubblesome.wsgi.application'
